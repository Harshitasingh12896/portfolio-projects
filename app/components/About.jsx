...
const About = () => {
  return (
    ...
    initial={{opacity:0}}
     ...
     viewport={{once:true}}
     id="about" className="w-full px-[12%] py-20 scroll-mt-10">
      <motion.h4 
      ...
      className="text-center mb-2 font-Ovo text-2xl">Introduction</motion.h4>
      <motion.h2
      initial={{opacity:0,x:-20}}
      transition={{duration:1}}
      whileInView={{opacity:1,x:0}}
      viewport={{once:true}}
       ...
       className="text-center font-Ovo text-7xl">About Me</motion.h2>
      ...
      <div className="flex flex-col lg:flex-row items-center gap-20 my-20">
        ...
        className="mx-auto">
          <Image
            src="/assets/beautiful.jpg.jpg"  // Use a static image from public/assets
            alt="My Image"
            width={300}
            height={300}
        ...
        <div className="flex-1">
          ...
          viewport={{once:true}}
           className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            {infoList.map(({ icon, title, description }, index) => (
              <li key={index} className="p-4 bg-white rounded-lg shadow-lg flex flex-col items-center text-center hover:bg-lightHover
          ...
          whileInView={{y:0,opacity:1}}
          viewport={{once:true}}
          className='font-Ovo text-2xl text-center mt-5 underline'>Tools I used</motion.h4>
          <motion.div
          initial={{scale:0}}
          transition={{duration:1.5,type:'spring',stiffness:100}}
          whileInView={{scale:1}}
          viewport={{once:true}}
          className="flex justify-center flex-wrap gap-6 mt-8 hover:bg-lightHover hover:-translate-y-1
          duration-500 ">

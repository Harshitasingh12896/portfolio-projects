...
import { workData } from "../../data/assets"; // Importing workData
...
const Work = ({ IsDarkmode }) => {
  return (
    <div id="work" className="w-full px-[12%] py-20 scroll-mt-20">
      ...
      >
        Welcome to my web development portfolio! Explore a collection of projects showcasing my expertise in frontend
        development.
      </motion.p>
      ...
      >
        {workData.map(({ title, description, bgImage }, index) => (
          <div
            key={index}
            className="group relative overflow-hidden rounded-lg hover:-translate-y-1 duration-500 hover:shadow-black"
      ...
      <motion.a
        ...
        whileInView={{ scale: 1 }}
        viewport={{ once: true }}
        href="#" // Fix: Replace with actual portfolio link
        className="text-xl flex items-center w-max justify-center gap-2 text-gray-700 border-[2px]
